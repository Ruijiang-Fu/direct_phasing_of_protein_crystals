...
program main
  ...
  character(len=4),parameter::PDB_ID='3ILZ'
  real,parameter::a=59.914d+0
  real,parameter::b=80.351d+0
  real,parameter::c=102.886d+0
  ...
  integer,parameter::anum=68  !59.914/0.8755    1.751/2=0.8755
  integer,parameter::bnum=92  !80.351/0.8755
  integer,parameter::cnum=118 !102.886/0.8756   !P212121
  ...
  real,parameter::cutoff_resolution=1.755 !not 1.751
  real,parameter::solvent_content0=0.62 !69.43%
